                                    ...
                                    <tbody>
                                        @foreach ($listCoupons as $index => $coupon)
                                            <tr>
                                                ...
                                                <td>                                                       
                                                    <a style="margin-right: 35px;" href="{{route('admins.coupons.edit',$coupon->id)}}"><i class="bi bi-pencil-fill"></i></a>
                                                    <form action="{{route('admins.coupons.destroy',$coupon->id)}}" method="post"
