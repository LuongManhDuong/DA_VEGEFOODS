                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ma_san_pham" value="{{$sanPham->ma_san_pham}}" name="ma_san_pham" class="form-control @error('ma_san_pham') is-invalid @enderror" 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="ten_san_pham" name="ten_san_pham" value="{{$sanPham->ten_san_pham}}" class="form-control
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="gia_san_pham" name="gia_san_pham" value="{{$sanPham->gia_san_pham}}" class="form-control
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="gia_khuyen_mai" name="gia_khuyen_mai" value="{{$sanPham->gia_khuyen_mai}}" class="form-control
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" id="so_luong" name="so_luong" value="{{$sanPham->so_luong}}" class="form-control
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="ngay_nhap" name="ngay_nhap" value="{{$sanPham->ngay_nhap}}" class="form-control
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @error('mo_ta_ngan') is-invalid @enderror" placeholder="Mô tả ngắn">{{old('mo_ta_ngan')}} {{$sanPham->mo_ta_ngan}}</textarea>
                                            @error('mo_ta_ngan') 
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-10 d-flex gap-2">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="trang_thai" id="gridRadios1" value="1" {{$sanPham->trang_thai == 1 ? 'checked' : ''}}>
                                                <label class="form-check-label text-success" for="gridRadios1">
                                                    Hiển thị
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="trang_thai" id="gridRadios2" value="0" {{$sanPham->trang_thai == 0 ? 'checked' : ''}}>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @error('noi_dung') is-invalid @enderror" placeholder="Nội dung">{{old('noi_dung')}} {{$sanPham->noi_dung}}</textarea>
                                            @error('noi_dung') 
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                                ...
                                                <tbody id="image-table-body">
                                                    ...
                                                    @foreach ($sanPham->hinhAnhSanPham as $index => $hinhAnh)
                                                        ...
                                                        <td class="d-flex align-items-center">
                                                            <img id="preview_{{$index}}" class="me-3" src="{{Storage::url($hinhAnh->hinh_anh)}}" alt="Hình ảnh sản phẩm"
                                                            style="width: 50px;">
