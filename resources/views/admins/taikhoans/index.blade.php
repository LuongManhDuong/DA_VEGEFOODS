                                    ...
                                    <tbody>
                                        @foreach ($listUser as $user)
                                            <tr>
                                                ...
                                                <td>{{ $user->role }}</td>
                                                <td>                                                       
                                                    {{-- <a style="margin-right: 35px;" href="{{route('admins.taikhoans.edit',$user->id)}}"><i class="bi bi-pencil-fill"></i></a> --}}
                                                    <form action="{{route('admins.taikhoans.destroy',$user->id)}}" method="post"
