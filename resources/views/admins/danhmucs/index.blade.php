                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('admins.danhmucs.create') }}" class="btn btn-primary"><i
                                        ...
                                        @foreach ($listDanhMuc as $index => $item)
                                            <tr>
                                                ...
                                                <td><img src="{{ Storage::url($item->hinh_anh) }}" alt="Hình ảnh sản phẩm"
                                                        width="100px" height="100px" style="object-fit: cover;"></td>
                                                ...
                                                <td>
                                                    <a href="{{ route('admins.danhmucs.edit', $item) }}" style="margin-right: 35px;">
                                                        <i class="bi bi-pencil-fill"></i>
                                                    </a>
                                                
                                                    <a class="border-0" href="#" data-bs-toggle="modal"
