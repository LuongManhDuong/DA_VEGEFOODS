...
<aside class="left-sidebar">
    ...
    <div>
      <div class="brand-logo d-flex align-items-center justify-content-between">
        <a href="{{route('admins.dashboard')}}" class="text-nowrap logo-img">
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="{{route('admins.coupons.index')}}" aria-expanded="false">
              <span>
        ...
        <div class="unlimited-access hide-menu bg-light-primary position-relative mb-7 mt-4 rounded">
          <div class="d-flex">
            <div class="unlimited-access-title me-3">
              ...
              <span href="#" target="_blank" class="btn btn-primary fs-2 fw-semibold lh-sm">Aaa~</span>
            </div>
