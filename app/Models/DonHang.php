...
class DonHang extends Model
{
    ...
    // public function getTrangThaiDonHangAttribute()
    // {
    //     return self::TRANG_THAI_DON_HANG[$this->attributes['trang_thai_don_hang']] ?? 'Không xác định';
    // }

    // public function getTrangThaiThanhToanAttribute()
    // {
    //     return self::TRANG_THAI_THANH_TOAN[$this->attributes['trang_thai_thanh_toan']] ?? 'Không xác định';
    // }
}
