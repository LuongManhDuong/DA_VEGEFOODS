...
class DonHangController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($currentTrangThai === DonHang::HUY_DON_HANG){
            return redirect()->route('admins.donhangs.index')->with('error', 'Đơn hàng đã bị huỷ không thể thay đổi được trạng thái');
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->back()->with('error', 'Không thể xoá đơn hàng');
